...
if ( ! function_exists( 'homey_cabins_setup' ) ) :
	...
	function homey_cabins_setup() {
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'homey-cabins' ),
			)
		);
 ...
 */
function homey_cabins_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'homey-cabins' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'homey-cabins' ),
